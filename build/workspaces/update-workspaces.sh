...
premake5 --outpath="../workspaces/gcc/" ${premake_args} gmake || die "Premake failed"
premake5 --outpath="../workspaces/codeblocks/" ${premake_args} codeblocks || die "Premake failed"

# Also generate xcode workspaces if on OS X
if [ "`uname -s`" = "Darwin" ]; then
  premake5 --outpath="../workspaces/xcode3" ${premake_args} xcode3 || die "Premake failed"
  premake5 --outpath="../workspaces/xcode4" ${premake_args} xcode4 || die "Premake failed"
fi
